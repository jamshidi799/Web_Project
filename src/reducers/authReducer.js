...
const initialState = {
    ...
    isLoading: false,
    user: { id: '1', username: 'ali', email: 'ali@gmail.com', password: '1234', bio: '', image_url: '', followings: [], followers: [] },
    users: [
        { id: '1', username: 'ali', email: 'ali@gmail.com', password: '1234', bio: 'aaaa', image_url: '', followings: [], followers: [] },
